...
class _CodeBuddyCliAdapter(HostSpecialAdapter):
    def build_usage_profile(self, context: SpecialAdapterContext) -> dict[str, object]:
        return {
            ...
            "post_onboard_steps": [
                "确认项目内已生成 `CODEBUDDY.md`、`.codebuddy/commands/super-dev.md`、`.codebuddy/commands/super-dev-seeai.md`、`.codebuddy/skills/super-dev-core/SKILL.md` 与 `.codebuddy/skills/super-dev-seeai/SKILL.md`。",
...
class _CodeBuddyIdeAdapter(HostSpecialAdapter):
    def build_usage_profile(self, context: SpecialAdapterContext) -> dict[str, object]:
        return {
            ...
            "requires_restart_after_onboard": False,
            "post_onboard_steps": [
                "确认项目内已生成 `CODEBUDDY.md`、`.codebuddy/rules/super-dev/RULE.mdc`、`.codebuddy/commands/super-dev.md`、`.codebuddy/commands/super-dev-seeai.md`、`.codebuddy/agents/super-dev-core.md`、`.codebuddy/skills/super-dev-core/SKILL.md` 与 `.codebuddy/skills/super-dev-seeai/SKILL.md`。",
    ...
    def build_usage_profile(self, context: SpecialAdapterContext) -> dict[str, object]:
        return {
            ...
            "post_onboard_steps": [
                ...
                "确认用户目录已生成 `~/.openclaw/skills/super-dev-core/SKILL.md` 与 `~/.openclaw/skills/super-dev-seeai/SKILL.md`。",
...
HOST_SPECIAL_ADAPTERS: dict[str, HostSpecialAdapter] = {
    ...
    "workbuddy": _WorkBuddyAdapter(
        host_id="workbuddy",
        adapter_mode_override="manual-workbench-skill",
        install_surfaces={
            "official_project_surfaces": (
                "WorkBuddy 当前任务会话中的 `super-dev:` / `super-dev-seeai:` 自然语言入口",
            ),
            "official_user_surfaces": (
                "WorkBuddy 技能市场 / 技能导入：Super Dev 标准版与 SEEAI 比赛版",
            ),
            "observed_compatibility_surfaces": (),
        },
        runtime_checklist=(
