...
export const TERMINAL_LINES = {
  zh: [
    ...
    { type: 'success', text: 'Successfully installed super-dev-2.3.4' },
    { type: 'blank', text: '' },
    { type: 'input', text: 'super-dev "搭建一个电商平台"' },
    { type: 'blank', text: '' },
    { type: 'brand', text: 'Super Dev v2.3.4 — Plan-Execute 引擎 + Overseer 监督者 + Claude/Codex 混合审查' },
  ...
  en: [
    ...
    { type: 'blank', text: '' },
    { type: 'brand', text: 'Super Dev v2.3.4 — Plan-Execute engine + Overseer + Claude/Codex hybrid review' },
    { type: 'info', text: 'Expert agent activated: e-commerce domain specialist' },
    { type: 'info', text: 'Phase 01 → research, then PRD / Architecture / UI/UX, then wait for confirmation.' },
    { type: 'blank', text: '' },
    { type: 'input', text: 'super-dev run 4' },
