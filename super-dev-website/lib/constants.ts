...
export const TERMINAL_LINES = {
  zh: [
    ...
    { type: 'success', text: 'Successfully installed super-dev-2.3.1' },
    { type: 'blank', text: '' },
    { type: 'input', text: 'super-dev "搭建一个电商平台"' },
    { type: 'blank', text: '' },
    { type: 'brand', text: 'Super Dev v2.3.1 — 让 AI 开发更标准地完成商业交付' },
  ...
  en: [
    ...
    { type: 'blank', text: '' },
    { type: 'brand', text: 'Super Dev v2.3.1 — Governed delivery for AI coding' },
    { type: 'info', text: 'Expert agent activated: e-commerce domain specialist' },
    { type: 'info', text: 'Phase 01 → research, then PRD / Architecture / UI/UX, then wait for confirmation.' },
    { type: 'blank', text: '' },
    { type: 'input', text: 'super-dev run 4' },
