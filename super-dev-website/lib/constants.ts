...
export const TERMINAL_LINES = {
  zh: [
    ...
    { type: 'success', text: 'Successfully installed super-dev-2.0.10' },
    { type: 'blank', text: '' },
    { type: 'input', text: 'super-dev' },
    { type: 'blank', text: '' },
    { type: 'brand', text: 'Super Dev v2.0.10 — 让 AI 开发更标准地完成商业交付' },
  ...
  en: [
    ...
    { type: 'input', text: 'super-dev' },
    { type: 'blank', text: '' },
    { type: 'brand', text: 'Super Dev v2.0.10 — Governed delivery for AI coding' },
    { type: 'info', text: 'Select hosts and write protocol surfaces...' },
    { type: 'output', text: 'claude-code    /super-dev' },
    { type: 'output', text: 'cursor         /super-dev' },
    { type: 'output', text: 'trae           super-dev:' },
