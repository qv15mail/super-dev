...
export const TERMINAL_LINES = {
  zh: [
    ...
    { type: 'success', text: 'Successfully installed super-dev-2.3.2' },
    { type: 'blank', text: '' },
    { type: 'input', text: 'super-dev "搭建一个电商平台"' },
    { type: 'blank', text: '' },
    { type: 'brand', text: 'Super Dev v2.3.2 — 20 个统一接入宿主 + 1 个 OpenClaw 手动插件宿主' },
  ...
  en: [
    ...
    { type: 'blank', text: '' },
    { type: 'brand', text: 'Super Dev v2.3.2 — Governed delivery for AI coding' },
    { type: 'info', text: 'Expert agent activated: e-commerce domain specialist' },
    { type: 'info', text: 'Phase 01 → research, then PRD / Architecture / UI/UX, then wait for confirmation.' },
    { type: 'blank', text: '' },
    { type: 'input', text: 'super-dev run 4' },
