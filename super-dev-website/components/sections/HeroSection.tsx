...
const COPY = {
  zh: {
    ...
    points: ['适配主流 CLI 与 IDE 宿主', '代码库理解、影响分析与回归守卫一体化', '输出可审计的工程交付资产与发布评分'],
    docs: '查看文档',
  ...
  en: {
    ...
    points: ['Works across major CLI and IDE hosts', 'Combines codebase intelligence, impact analysis, and regression guard', 'Produces auditable delivery assets and release scoring'],
    docs: 'Read Docs',
      ...
      <div className="relative mx-auto flex w-full max-w-7xl flex-col gap-14 px-4 pb-20 sm:px-6 lg:grid lg:grid-cols-[minmax(0,1fr)_520px] lg:items-center lg:gap-16 lg:pb-24">
        <div className="flex flex-col gap-7">
          <div className="flex flex-wrap items-center gap-2">
            <Badge variant="version">v2.0.11</Badge>
