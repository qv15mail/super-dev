...
const COPY = {
  zh: {
    ...
    body: '辅助用户在 Claude Code、Cursor、Codex、Trae 等开发工具中，更标准地完成商业交付。接手项目时先看代码库地图和改动影响范围，再按 research、三文档、确认门、Spec、前端验证、质量门禁和交付标准推进。',
  ...
  en: {
    ...
    body: 'Use Super Dev inside Claude Code, Cursor, Codex, Trae, and similar tools to move from requirement to delivery through one governed path: repo map, impact analysis, research, the three core docs, approval, spec, frontend validation, quality gates, and delivery standards.',
      ...
      <div className="relative mx-auto flex w-full max-w-7xl flex-col gap-14 px-4 pb-20 sm:px-6 lg:grid lg:grid-cols-[minmax(0,1fr)_520px] lg:items-center lg:gap-16 lg:pb-24">
        <div className="flex flex-col gap-7">
          <div className="flex flex-wrap items-center gap-2">
            <Badge variant="version">v2.0.10</Badge>
